...
import styles from './PagesStyle/SearchPage.module.css'; // Import CSS module correctly
...
function SearchPage() {
  ...
  return <div
   ...
   >
    ...
    <section className={styles.secn3}> {/* Use CSS module class */}
      <div className={styles.resultDiv}> {/* Use CSS module class */}
        <img
